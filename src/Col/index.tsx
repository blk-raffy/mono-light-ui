    ...
    Object.keys(props.breakpoints).map((key, index) => {
      if (index === Object.keys(props.breakpoints).length - 1) {
        return `@media(min-width: ${props.breakpoints[key]}px) {
                    ...
                    margin-left: ${
                      props.offset[index] !== 'auto'
                        ? `${
                            ((props.offset[index] || props.offset[0] || 0) /
                              props.column) *
                            100
                          }%`
                        : null
                    ...
                    flex: ${
                      props.span[index] !== 'auto' ? 'none !important' : null
                    };
                    padding: ${
                      props.gutter != 'none' ? `${props.gutter}` : '0'
                    }px;
                }`;
      } else {
